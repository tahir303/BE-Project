...
haar=pkg_resources.resource_filename('cv2','C:\\Users\\tahir\\PycharmProjects\\Face-recognition-based-automatic-attendance--main\\FRAS\\haarcascade_frontalface_default.xml')
            ...
            for col in range(2,3):
                ...
                for i in namelist:
                    if i==val:
                        ...
                        c1 = ws.cell(row, column)
                        c1.value = "P" 
        wb.save("C:\Users\tahir\PycharmProjects\Face-recognition-based-automatic-attendance--main\FRAS\Attendance\sheet3.xlsx")
