...
directory="C:\\Users\\tahir\\PycharmProjects\\Face-recognition-based-automatic-attendance--main\\FRAS\\"
...
class facerecognitionsystem:
    def __init__(self, FR_wind):
        ...
        std_b1_1 = Button(bck_lbl,command=self.facerecognize, text="Start Attendance",cursor="hand2",font=("tahoma",15,"bold"),bg="white",fg="navyblue")
        ...
        std_b1_2 = Button(bck_lbl,command=self.txttolist,text="Save Attendance",cursor="hand2",font=("tahoma",15,"bold"),bg="white",fg="navyblue")
        ...
        sub_combo["values"]=("Select Subject","FE","SE","TE","BE")
        sub_combo.current(0)
    ...
    def markA(self,namelist):
        ...
        if sub!="Select Subject":
            ...
            wb.save("C:\\Users\\tahir\PycharmProjects\\Face-recognition-based-automatic-attendance--main\\FRAS\Attendance\\sheet_"+sub+".xlsx")
